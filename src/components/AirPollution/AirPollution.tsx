...
const AirPollution = () => {
  ...
  return (
    <div className="air-pollution sm-2:col-span-2 col-span-full flex h-[12rem] flex-col gap-8 rounded-lg border px-4 pb-5 pt-6 shadow-sm dark:bg-dark-gray dark:shadow-none">

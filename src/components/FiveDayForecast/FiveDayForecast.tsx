...
import { kelvinToCelsius, unixToDay } from "@/app/utils/mics";
...
function FiveDayForecast() {
  ...
  return (
    <div className="dark:bg-dark-grey flex flex-1 flex-col justify-between rounded-lg border px-4 pb-5 pt-6 shadow-sm dark:shadow-none">
      <div>
